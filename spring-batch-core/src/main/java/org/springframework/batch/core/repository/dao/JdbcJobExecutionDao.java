...
public class JdbcJobExecutionDao extends AbstractJdbcBatchMetadataDao implements JobExecutionDao, InitializingBean {
    ...
    public int getJobExecutionCount(JobInstance jobInstance) {
        ...
        return getJdbcTemplate().queryForObject(getQuery(GET_JOB_EXECUTION_COUNT), Integer.class, parameters);
    }
    ...
    public void updateJobExecution(JobExecution jobExecution) {
        ...
        if (getJdbcTemplate().queryForObject(getQuery(CHECK_JOB_EXECUTION_EXISTS), Integer.class, new Object[]{jobExecution.getId()}) != 1) {
     ...
     * @author Dave Syer
     */
    private class JobExecutionRowMapper implements RowMapper<JobExecution> {
