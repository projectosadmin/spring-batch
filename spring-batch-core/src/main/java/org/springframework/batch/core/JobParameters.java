...
public class JobParameters implements Serializable {
     ...
     */
    public JobParameters(Map<String, String> stringMap, Map<String, Long> longMap, Map<String, Double> doubleMap, Map<String, Date> dateMap) {
        super();
    ...
    public Map<String, Object> getParameters() {
        Map<String, Object> tempMap = new LinkedHashMap<>(stringMap);
     ...
     */
    private void validateMap(Map<String, ?> map, Class<?> type) {
    ...
    public boolean equals(Object obj) {
        ...
        // Map.equals()
        return getParameters().equals(parameters.getParameters());
    }
