...
public class TradeJobFunctionalTests extends AbstractValidatingBatchLauncherTests {
    ...
    @Autowired
    @Qualifier("customerFileLocator")
    private FileSystemResource customerFileLocator;
    @Autowired
    @Qualifier("fileLocator")
    ...
    protected void validatePostConditions() {
        ...
        customers = new ArrayList() {{
            add(new Customer("customer1", (((Double) credits.get("customer1")).doubleValue() - 98.34)));
        ...
        trades = new ArrayList() {{
            add(new Trade("UK21341EAH45", 978, new BigDecimal("98.34"), "customer1"));
...
//		 Clean up
        customerFileLocator.getFile().delete();
    }

    protected void validatePreConditions() {
        assertTrue(fileLocator.exists());
    }
